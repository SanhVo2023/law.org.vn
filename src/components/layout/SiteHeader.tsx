    ...
    <header className="no-print sticky top-0 z-40 border-b border-[var(--rule)] bg-[var(--bg)]/90 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-6 px-4 md:px-6">
        <Link href="/" className="group flex items-center gap-2.5">
          ...
          <span className="hidden whitespace-nowrap border-l border-[var(--rule)] pl-2.5 text-[0.62rem] uppercase tracking-[0.16em] text-[var(--fg-muted)] transition group-hover:text-[var(--color-gold-500)] xl:inline">
            {t('site.tagline')}
          </span>
        </Link>
